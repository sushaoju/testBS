...
public class XNDrug {
	...
	//10个全部
	public XNDrug(int id, String ypbh, String ypmc, String lb, String sccs,
	...
	public XNDrug(int id, String ypbh, String ypmc, String lb, String sccs,
			String yptm, String ggxh, String pzwh, String bz,double jg,String picture) {
		super();
		this.id = id;
		this.ypbh = ypbh;
		this.ypmc = ypmc;
...
//9个，根据id返数据的	
	public XNDrug(String ypbh, String ypmc, String lb, String sccs,
			String yptm, String ggxh, String pzwh, String bz,double jg) {
		super();
		this.ypbh = ypbh;
		this.ypmc = ypmc;
