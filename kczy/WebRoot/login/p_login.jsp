...
<html>
  ...
  <body background="../image/8.jpg">
    <div id="dlg" class="easyui-dialog" title="登录" data-options="closed:false" style="background-image:url(<%=request.getContextPath() %>/image/8.jpg);width:400px;height:200px;padding:10px">
