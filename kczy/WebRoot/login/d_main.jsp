  ...
  <%
	...
	<div data-options="region:'west',split:false,title:'系统菜单'" 
			...
			<div id="aa" class="easyui-accordion" data-option="fit:true" >
				<div title="自主购药" data-options="iconCls:'icon-stock'" style="overflow:auto;padding:10px;"></div>
				<div title="网上问诊" data-options="iconCls:'icon-finance'" style="overflow:auto;padding:10px;">
				<ul>
						<a href="javascript:addPanel('挂号单查看','<%=request.getContextPath()%>/gh/ghgl.jsp')" 
						class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-analysis'">挂号单查看</a>
						...
						<a href="javascript:addPanel('我要开处方','<%=request.getContextPath()%>/cfd/cfd.jsp')" 
						class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-analysis'">我要开处方</a>
				...
				<div title="在线提问" data-options="iconCls:'icon-system'" style="overflow:auto;padding:10px;">
					<ul>							
							<a href="javascript:addPanel('回答问题管理','<%=request.getContextPath()%>/zxtw/Answer.jsp')" 
							class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-admin'">回答问题管理</a>						
					</ul>
	...
	<div data-options="region:'center'">
		<div id="tt" class="easyui-tabs" data-options="border:false,fit:true" 	
			...
			<font face="宋体" size=4 color="red">&nbsp;&nbsp;网络看病是互联网时代的特有产物，它打破了时空、地域限制，
			使得世界各地的“专家会诊”成为现实。它降低了交通成本，推进了“医术”的繁荣和发展，
			从而进一步增进了世界的科学技术和文化情感的交融。</font>
			<img src="<%=request.getContextPath()%>/image/12.jpg" width="100%" height="100%">
			</div>
