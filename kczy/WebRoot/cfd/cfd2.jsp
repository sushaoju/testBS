	    ...
	    <form id="ff" class="easyui-form" method="post" data-options="novalidate:true">
	    	...
	    	<table cellpadding="5">
	    		<tr>
	    			...
	    			data-options="required:true" style="width:200px" value="02"></input></td>
                <tr>
	    			<td>药品名称:</td>
	    			<td><input class="easyui-textbox" 
	    			type="text" name="ypmc"
	    			
	    			data-options="required:true" style="width:200px" value="克拉霉素"></input></td>
	    		</tr>
	    		<tr>
	    			<td>数量:</td>
	    			<td><input type="text" name="sl"
	    			 data-options="required:false" style="width:200px" value="3"></td>
	    	</tr>	
	    	<tr>
	    			<td>总金额:</td>
	    			<td><input type="text" name="zje" value="55"> 
