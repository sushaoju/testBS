	    ...
	    <form id="ff" class="easyui-form" method="post" data-options="novalidate:true">
	    	...
	    	<table cellpadding="5">
	    		<tr>
	    			...
	    			data-options="required:true" style="width:200px" value="01"></input></td>
                <tr>
	    			<td>药品名称:</td>
	    			<td><input class="easyui-textbox" 
	    			type="text" name="ypmc"
	    			
	    			data-options="required:true" style="width:200px" value="999感冒灵"></input></td>
	    		</tr>
	    		<tr>
	    			<td>数量:</td>
	    			<td><input type="text" name="ssgs"
	    			 data-options="required:false" style="width:200px" value="2"></td>
	    	</tr>	
	    	<tr>
	    			<td>总金额:</td>
	    			<td><input type="text" name="zje" value="25"> 
