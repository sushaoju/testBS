...
<head>
  ...
  <body>
    <div class="easyui-panel" title="药品购买" style="width:95%">
		<div style="padding:10px 60px 20px 60px">
			...
			<div style="text-align:left;padding:5px">
			    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="addorder()">付款</a>
				<a href="<%=request.getContextPath()%>/zzxy/xinnaoDrug_list.jsp" class="easyui-linkbutton" >关闭</a>
           </div>
		</div>
	</div>
    ...
    <script>
	      ...
	      $(function(){	
			$("#ff").form("load","<%=request.getContextPath()%>/servlet/XNDrugServlet?reqCode=findXNDrugById&id="+id);
		  });
	      
	      function addorder(){
			$('#ff').form('submit',{
				url:"<%=request.getContextPath()%>/servlet/OrderServlet?reqCode=addOrder",
								onSubmit : function() {
