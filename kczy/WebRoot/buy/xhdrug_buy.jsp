...
<head>
  ...
  <body>
    <div class="easyui-panel" title="药品购买" style="width:95%">
		<div style="padding:10px 60px 20px 60px">
			...
			<div style="text-align:left;padding:5px">
				...
				<a href="<%=request.getContextPath()%>/zzxy/huxiDrug_list.jsp" class="easyui-linkbutton" >关闭</a>
           </div>
		</div>
	</div>
    ...
    <script>
	      ...
	      $(function(){	
			$("#ff").form("load","<%=request.getContextPath()%>/servlet/XHDrugServlet?reqCode=findXHDrugById&id="+id);
		  });
