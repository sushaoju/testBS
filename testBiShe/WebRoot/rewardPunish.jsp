    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                            <table id="rp_tbl" data-mobile-responsive="true" class="table table-striped table-hover">
                                <thead>
                                <tr>
                                    <th>工号</th>
                                    <th>姓名</th>
...
<div id="edit_box">
    ...
    <form>
        ...
        <div class="from-group">
            <div class="col-sm-6">
                <label for="e_happenDate">发生时间:</label>
                <input class="form-control" type="date"  id="e_happenDate">
            </div>
			
			<div class="col-sm-6">
                <label for="e_happenType">类型:</label>
               <select name="e_happenType" id="e_happenType" class="form-control">
        ...
        <div class="from-group">
            <div class="col-sm-6">
                <label for="e_changeMoney">金额变动:</label>
                <input class="form-control" type="text" placeholder="请输入交接人" id="e_changeMoney">
            </div>
        </div>
		<div class="clearfix hidden-xs"></div>
        ...
        <div class="from-group">
            <div class="col-sm-12">
                <label for="e_happenReason" style="vertical-align: top">原因:</label>
                <textarea name="e_happenReason" id="e_happenReason" cols="30" rows="10" style="resize:none;"></textarea>
            </div>
        </div>
...
<div id="add_box">
    ...
    <form>
       ...
       <div class="form-group">
            <div class="col-sm-6">
                <label for="a_stuffID">工号:</label>
               <input class="form-control" type="date"  id="a_stuffID">
            </div>
            <div class="clearfix hidden-xs"></div>
        </div>
        ...
        <div class="from-group">
            <div class="col-sm-6">
                <label for="a_happenDate">发生时间:</label>
                <input class="form-control" type="date"  id="a_happenDate">
            </div>
			
			<div class="col-sm-6">
                <label for="a_happenType">类型:</label>
               <select name="a_happenType" id="a_happenType" class="form-control">
                        <option value="奖">奖</option>
                        <option value="惩">惩</option>
                </select>
            </div>
        ...
        <div class="from-group">
            <div class="col-sm-6">
                <label for="a_changeMoney">金额变动:</label>
                <input class="form-control" type="text" placeholder="请输入交接人" id="a_changeMoney">
            </div>
        </div>
		<div class="clearfix hidden-xs"></div>
        ...
        <div class="from-group">
            <div class="col-sm-12">
                <label for="a_happenReason" style="vertical-align: top">原因:</label>
                <textarea name="a_happenReason" id="a_happenReason" cols="30" rows="10" style="resize:none;"></textarea>
            </div>
        </div>
