                        ...
                        <div class="example">
                            <table id="exampleTableColumns" data-mobile-responsive="true">
                                ...
                                <tr>
                                    ...
                                    <th data-field="column5" data-visible="false">任职状态</th>
                                    <th data-field="column6" data-visible="true">调薪日期</th>
    ...
    <form>
        ...
        <div class="from-group">
            ...
            <div class="col-sm-6">
                ...
                <input class="form-control" type="text" placeholder="请输入调薪时间" id="e_adjustMoney">
            </div>
        </div>
...
<div id="add_box">
    ...
    <form>
        ...
        <div class="from-group">
            ...
            <div class="col-sm-6">
                <label for="a_adjustMoney">调岗时间:</label>
                <input class="form-control" type="text" placeholder="请输入调薪时间" id="a_adjustMoney">
            </div>
        </div>
